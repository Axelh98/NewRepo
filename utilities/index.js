...
Util.buildVehicleDetail = async function (vehicle) {
  ...
  detail +=
    '<p class="veh-price">Price: $' +
    new Intl.NumberFormat("en-US").format(vehicle.inv_price) +
    "</p>";
  detail +=
    '<p class="veh-p"><span>Descripcion</span>: ' +
    vehicle.inv_description +
    "</p>";
  detail +=
    '<p class="veh-p"><span>Color</span>:' + " " + vehicle.inv_color + "</p>";
  detail +=
    '<p class="veh-p"><span>Milles</span>' + " " + vehicle.inv_miles + "</p>";
